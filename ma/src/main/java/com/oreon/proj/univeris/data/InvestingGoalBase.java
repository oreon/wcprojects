...
@MappedSuperclass
public class InvestingGoalBase extends BaseEntity {
	...
	@JoinColumn(name = "investingGoalPlanCode_id", nullable = false, updatable = true)
	...
	public List<String> listSearchableFields() {
		...
		listSearchableFields.add("imageFileIri");
	...
	public String getSearchData() {
		...
		builder.append(getImageFileIri() + " ");

		if (getInvestingGoalPlanCode() != null)
			builder.append("investingGoalPlanCode:"
					+ getInvestingGoalPlanCode().getDisplayName() + " ");

		return builder.toString();
	}

	/*
	<param name="investingGoalPlanCodeId" value="#{investingGoalPlanCodeId}" />
